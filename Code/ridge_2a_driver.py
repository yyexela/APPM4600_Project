...
if save_plots:
    plt.savefig("../Images/2a_initial_gammas.pdf")
else:
    plt.show()
plt.close()
...
if save_plots:
    plt.savefig("../Images/2a_seed50_gammas.pdf")
else:
    plt.show()
plt.close()
...
if save_plots:
    plt.savefig("../Images/2a_seeds1_100.pdf")
else:
    plt.show()
plt.close()
...
if save_plots:
    plt.savefig("../Images/2a_seeds1_100mean.pdf")
else:
    plt.show()
plt.close()
...
if save_plots:
    plt.savefig("../Images/2a_seeds1_100mean_zoomed.pdf")
else:
    plt.show()
plt.close()
